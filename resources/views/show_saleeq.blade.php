...
<div class="row">
        ...
        <div class="col-2">{{$saleeq[0]->listseq_id}}</div>
    </div>
    <div class="row">
            <div class="col-3 right" >รายการสินค้า</div>
            <div class="col-2">{{$saleeq[0]->eq_name}} </div>
            <div class="col-3 right" >วันที่</div>
            <div class="col-2">{{$saleeq[0]->seq_date}}</div>
        </div>
<div class="row">
        <div class="col-3 right" > จำนวน</div>
        <div class="col-2">{{$saleeq[0]->seq_amount}}</div>
        <div class="col-3 right" > ยอดขายสุทธิ</div>
        <div class="col-2">{{number_format($saleeq[0]->seq_pricetotal,2)}}&ensp;บาท</div>
    </div>
    <br>
    <div class="btncenter"  >
